...
typedef enum {
	...
	MAL_ERROR_MEMORY = -9,					//!< MAL_ERROR_MEMORY
	MAL_ERROR_OPERATION_INVALID = -10,		//!< MAL_ERROR_OPERATION_INVALID
	MAL_ERROR_NOT_FOUND = -11,				//!< MAL_ERROR_NOT_FOUND
	MAL_ERROR_ALREADY_INITIALIZED = -12	,   //!< MAL_ERROR_ALREADY_INITIALIZED
	MAL_ERROR_IN_PROGRESS = -13	            //!< MAL_ERROR_IN_PROGRESS
} mal_error_e;
