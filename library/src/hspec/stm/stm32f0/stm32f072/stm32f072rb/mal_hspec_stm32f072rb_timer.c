...
#include "mal_hspec_stm32f072rb_timer.h"
...
mal_error_e mal_hspec_stm32f072rb_get_valid_channel_ios(mal_timer_e timer, const mal_hspec_gpio_s **ios, uint8_t *size) {
	switch (timer) {
		case MAL_TIMER_1:
